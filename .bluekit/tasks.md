...
- [ ] **Bug swap into tasks workflow** - `Complexity: Low`
  - Convert bug reports into task workflow items
...
- [ ] **Claude is ugly with rendering the content from the tool call** - `Complexity: Medium`
  - Improve rendering of MCP tool call content in chat interface
...
- [ ] **Pinning kits** - `Complexity: Low`
  - Allow users to pin frequently used kits
...
- [ ] **Better error handling on diagrams - make it copy pastable** - `Complexity: Low`
  - Improve diagram error handling and add copy/paste functionality
...
- [ ] **Thoughts on sources/destinations** - `Complexity: Medium`
  - Research and design sources/destinations architecture
...
- [ ] **Workflow research - what would it take to** - `Complexity: Medium`
  - Research workflow implementation requirements
...
- [ ] **Dead/bad code** - `Complexity: Medium`
  - Identify and handle dead/unused code detection

---

## Complexity Legend

- **Low**: Simple feature, minimal dependencies, straightforward implementation
- **Medium**: Moderate complexity, may require multiple components or integrations
- **High**: Complex feature, significant architecture work, multiple systems involved
